...
export interface DatePickerProps {
     ...
     * @returns `React.ReactNode`
     */
    footerRender?(current: Date | null, footerNode: React.ReactNode): React.ReactNode;
    /**
     ...
     * @returns `React.ReactNode`
     */
    headerRender?(current: Date | null, headerNode: React.ReactNode): React.ReactNode;
    /**
...
interface DatePickerPickable extends Pick<DatePickerProps, "value" | "defaultValue" | "onChange" | "onDayChange" | "onMonthChange" | "onYearChange" | "format" | "locale" | "disabledDates" | "customColors"> {
}
type InputBuiltInProps = Omit<React.HtmlHTMLAttributes<HTMLInputElement>, "value" | "onChange" | "defaultValue">;
