...
export interface RangePickerProps {
     ...
     * @param `dateStrings`
     */
    onChange?(date: [Moment, Moment | null] | null, dateStrings: [string, string]): void;
    /**
     ...
     */
    dayRender?(dateRange: [Moment, Moment], dayNode: React.ReactNode): React.ReactNode;
    /**
     ...
     * @returns `React.ReactNode`
     */
    headerRender?(dateRange: [Moment, Moment | null] | null, headerNode: React.ReactNode): React.ReactNode;
    /**
     ...
     * @returns `React.ReactNode`
     */
    panelRender?(dateRange: [PanelRange, PanelRange], panelNode: React.ReactNode): React.ReactNode;
    /**
     ...
     * @returns `React.ReactNode`
     */
    dayLabelRender?(labels: string[], labelNode: React.ReactNode): React.ReactNode;
...
interface RangePickerPickable extends Pick<RangePickerProps, "defaultValue" | "value" | "onChange" | "onDayChange" | "onMonthChange" | "onYearChange" | "format" | "locale" | "disabledDates" | "customColors"> {
}
type InputBuiltInProps = Omit<React.HtmlHTMLAttributes<HTMLInputElement>, "value" | "onChange" | "defaultValue" | "placeholder">;
